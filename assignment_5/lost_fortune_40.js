...
while (playAgain == "y" && lives > 0) {
    ...
    function leaderName() {
        ...
        console.log("Add two more members to your team to help you in this quest");
        return leaderName;
    }
    leaderName();
...
module.exports = lost_fortune_40, displayMenu();
